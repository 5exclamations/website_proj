const site = {
  az: {
    ...
    home: {
      ...
      text: "Vüsalə Qasımova BAK terapiyasını Azərbaycanda tətbiq edən ilk mütəxəssislərdəndir. Metod emosional-iradi və koqnitiv sahələrin dəstəklənməsinə yönəlib.",
      ...
      approachDetailText: "Məqsədim xəstələrə ən müasir, effektiv və təhlükəsiz neyropsixoloji dəstəyi təqdim etməkdir.",
      integrationTitle: "Azərbaycanda BAK terapiyasının inteqrasiyası",
      integrationText: "Bu innovativ, qeyri-invaziv metod nevroloji və psixoloji çətinliklərdə elmlə praktik qayğını birləşdirir.",
      ...
      whatText: "BAK metodu EEG məlumatını real vaxtda akustik siqnala çevirərək beynin özünü tənzimləmə mexanizmlərini dəstəkləyir.",
      ...
      transformText: "Sertifikatlı mütəxəssislərimizlə konsultasiya edin.",
  ...
  en: {
    ...
    home: {
      ...
      text: "Dr. Vusala Gasimova is among the first specialists in Azerbaijan introducing BAC therapy.",
      ...
      approachDetailText: "My mission is to deliver modern, effective, and safe neuropsychological care.",
      integrationTitle: "Integrating BAC therapy in Azerbaijan",
      integrationText: "This innovative non-invasive method bridges science and patient care.",
      ...
      whatText: "BAC converts EEG data into real-time acoustic signals to support brain self-regulation.",
      ...
      transformText: "Consult our certified specialists.",
  ...
  ru: {
    ...
    home: {
      ...
      text: "Вусала Касимова — один из первых специалистов в Азербайджане, внедривших BAC-терапию.",
      cta: "Book Appointment",
      more: "Learn more",
      approachTitle: "My Approach",
      ...
      approachDetailText: "Я верю в преобразующую силу передовых технологий и внедряю современные методы помощи пациентам.",
      integrationTitle: "Интеграция BAC-терапии в нейропсихологию в Азербайджане",
      integrationText: "Этот инновационный неинвазивный метод объединяет науку и практическую помощь при неврологических и психологических трудностях.",
      integrationMore: "Learn more",
      integrationCta: "Book Appointment",
      whatTitle: "Что Такое BAC-Терапия",
      whatSubtitle: "Биоакустическая коррекционная терапия",
      whatText: "Метод биоакустической коррекции использует данные ЭЭГ, преобразованные в акустические сигналы в реальном времени, чтобы поддерживать саморегуляцию мозга.",
      ...
      transformText: "Проконсультируйтесь с нашими сертифицированными специалистами.",
      transformCta: "Book Appointment"
    },
    bac: {
